...
class CapML {
     ...
     */
    fun imageProcessingFailed(call: PluginCall, tag: String?, errMsg: String?) {
        Log.e(tag, errMsg!!)
        val ret = JSObject()
        ret.put("name", "")
        ret.put("data", "")
    ...
    fun runTorchBitmapClassify(call: PluginCall, bmp: Bitmap?, content: Context) {
        ...
        try {
            ...
            val className = IMAGENET_CLASSES[maxScoreIdx]
            val logStr = "Selected Class: $className Score: $maxScore"
            Log.i("ImageAI", logStr)

            // send data to frontend
            val data = JSObject()
            data.put("className", className)
            data.put("confidence", maxScore.toDouble())
            val ret = JSObject()
            ret.put("id", "ImageAI")
            ret.put("type", "ai")
            ret.put("data", data)
