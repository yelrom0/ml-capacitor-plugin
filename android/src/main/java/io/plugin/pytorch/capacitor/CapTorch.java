...
public class CapTorch {
    ...
    public final String[] IMAGENET_CLASSES = new String[] {
        "tench, Tinca tinca",
     ...
     */
    public void imageProcessingFailed(PluginCall call, String tag, String errMsg) {
        Log.e(tag, errMsg);
    ...
    public void runTorchBitmapClassify(PluginCall call, Bitmap bmp, Context content) {
        Module model = null;
        ...
        try {
            ...
            final String className = IMAGENET_CLASSES[maxScoreIdx];
            final String logStr = "Selected Class: " + className + " Score: " + maxScore;
            Log.i("ImageAI", logStr);

            // send data to frontend
            JSObject ret = new JSObject();
            ret.put("className", className);
            ret.put("score", maxScore);
            call.resolve(ret);
